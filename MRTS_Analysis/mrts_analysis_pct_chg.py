...
ax[0,0].plot(df_dict['Book']['Sales_Date'],df_dict['Book']['Amount'].pct_change())
ax[0,0].set_title('Book Stores')

ax[0,1].plot(df_dict['Sporting']['Sales_Date'],df_dict['Sporting']['Amount'].pct_change())
ax[0,1].set_title('Sporting Goods Stores')

ax[1,0].plot(df_dict['Hobby']['Sales_Date'],df_dict['Hobby']['Amount'].pct_change())
ax[1,0].set_title('Hobby Toy and Game Stores')

ax[1,1].plot(df_dict['Retail']['Sales_Date'],df_dict['Retail']['Amount'].pct_change())
